...
from schemas import NBD_GOVERNANCE_IR_SCHEMA, NBD_IR_SCHEMA, NBD_PROMPT_IR_SCHEMA, NBD_RECALL_IR_SCHEMA, NBDItem
from utils import read_text, relative_path, run_path, vcc, write_text
...
def parse_recall_profile(markdown: str, keyword_groups: dict[str, list[str]]) -> dict[str, Any]:
    ...
    for name, values in groups.items():
        ...
        if any(part in name for part in ["冲突", "并列"]):
