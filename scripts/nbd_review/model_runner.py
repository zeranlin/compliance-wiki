...
from schemas import MODEL_REVIEW_RESULT_SCHEMA, DocumentBlock, NBDItem
from postprocessor import model_quality_flags
from prompt_runner import build_messages, prompt_stats, read_prompt_messages, write_prompt_files
from recall_runner import build_candidate_windows, candidate_set_payload, load_candidate_set
from utils import now_text, read_text, relative_path, run_path, vcc, write_text
...
def write_model_result_artifact(
    ...
    windows, recall_stats = load_candidate_set(output_dir, item)
    refs = artifact_refs(output_dir, item)
