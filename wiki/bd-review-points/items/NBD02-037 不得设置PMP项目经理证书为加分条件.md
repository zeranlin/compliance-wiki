...
# NBD02-037 不得设置PMP项目经理证书为加分条件

## 审查目标
在采购文件“评审因素”中检索是否设置了“PMP项目经理”证书，若检索到该证书，则判定为风险，并进行风险提示。
...
## 命中条件
同时满足以下条件时，输出命中：
- 评分标准或评审因素中出现与“证书、PMP、资质证照、认证证书”相关的评价对象。
...
## 风险提示
PMP证书颁发单位为境外机构，证书颁发单位未经过国内相关部门备案，可能存在合规风险

## 修改建议
删除PMP项目经理证书。如确认此证书与本项目需求相关，建议将此岗位人员名称调整为：XX管理人员，以避免上述清单中提出的问题。
